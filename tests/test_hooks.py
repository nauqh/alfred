...
@pytest.mark.asyncio
async def test_player_connected_accepts_a_connected_player(player: AlfredPlayer) -> None:
    await run_hook(hooks.player_connected, context(), lavalink_client=FakeLavalinkClient(player))


@pytest.mark.asyncio
async def test_player_playing_requires_a_loaded_track(player: AlfredPlayer) -> None:
...
@pytest.mark.asyncio
async def test_player_playing_accepts_a_playing_player(player: AlfredPlayer) -> None:
